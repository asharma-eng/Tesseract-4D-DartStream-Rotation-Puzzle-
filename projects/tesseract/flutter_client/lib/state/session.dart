...
class Session extends ChangeNotifier {
  ...
  Future<void> signUp(String email, String password, {http.Client? httpClient}) => _authenticate(
  ...
  Future<void> signIn(String email, String password, {http.Client? httpClient}) => _authenticate(
